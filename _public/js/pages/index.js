...
// CONSTs
const FILE_NAME = 'myfiles';

// SELECTORs
const submitBtn = document.getElementById("js-submitBtnID");
const submitForm = document.getElementById("js-formID");
const fileContainer = document.getElementById("js-files");

// SERVICEs
garcol.submitHandler = () => {
    const files = FilePackage.createData(FILE_NAME, fileContainer);
...
},{"../utils/ApiCaller":29,"../utils/FilePackage":30}],29:[function(require,module,exports){
...
class ApiCaller {
     ...
     */
    post = async (url, params, headers, handler, errorCallback, finallyCallback) => {
        try {
            headers = headers || this.HEADER_JSON ;
...
class FilePackage {
    ...
    createData = (name, selector) => {
        const formData = new FormData();
        formData.append(name, selector.files);
        return formData;
    }
}
